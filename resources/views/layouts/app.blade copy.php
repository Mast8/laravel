  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <li class="logo">
            <a href="{{ url('/home') }}" class="nav-links">
            <span class="link-text logo-text">Improve</span>
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fad"
            ...
            @else
                ...
                <li class="nav-item">
                    <a href="/admin/proyectos" class="nav-links">
                      <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fad"
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 512 512"
                        class="svg-inline--fa fa-briefcase fa-w-16 fa-9x"
                      >
                        <g class="fa-group">
                          <path
                            fill="currentColor"
                      ...
                      <span class="link-text">Todos los Proyectos</span>
                    </a>
                  </li>

                  <li class="nav-item">
                    <a href="{{ route('users.index') }}" class="nav-links">
                      <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fad"
            ...
            <li class="nav-item">
                <a href="{{ route('projects.index') }}" class="nav-links">
                <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fad"
                ...
                <span class="link-text">Proyecto</span>
                </a>
            </li>

            <li class="nav-item">
                <a href="/usuarios/{{ Auth::user()->id }}/editar" class="nav-links">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fad"
              ...
              <li class="nav-item">
                ...
                document.getElementById('logout-form').submit();" class="nav-links">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fad"
